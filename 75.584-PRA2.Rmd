...
```{r}
modeloRL <- glm(output ~ chol, data = test, family = "binomial")
summary(modeloRL)
plot(output ~ chol, test, col = "darkblue",
     main = "Modelo regresión logística",
     ylab = "P(output=1|colesterol)",
     xlab = "colesterol", pch = "I")

# type = "response" devuelve las predicciones en forma de probabilidad en lugar de en log_ODDs
curve(predict(modeloRL, data.frame(chol = x), type = "response"),
      col = "firebrick", lwd = 2.5, add = TRUE)


modeloRL <- glm(output ~ age, data = test, family = "binomial")
summary(modeloRL)
plot(output ~ age, test, col = "darkblue",
     main = "Modelo regresión logística",
     ylab = "P(output=1|colesterol)",
     xlab = "age", pch = "I")

# type = "response" devuelve las predicciones en forma de probabilidad en lugar de en log_ODDs
curve(predict(modeloRL, data.frame(age = x), type = "response"),
      col = "firebrick", lwd = 2.5, add = TRUE)
