...
En el caso observado, se puede ver que la OR para la variable `cpNon-anginal pain` es de 6.05, lo que significa que tener angina atípica tiene 6.05 veces más probabilidades de tener un ataque cardíaco en comparación con tener una angina típica.
...
En el caso del paciente 12, la probabilidad de tener un ataque cardíaco es de 0.925 o 92.5%. Esto significa que según el modelo, hay un 92.5% de posibilidades de que ese paciente sufra un ataque cardíaco. En el caso del paciente 200, la probabilidad es de 0.019 o 2%. Esto significa que según el modelo, hay un 2% de posibilidades de que ese paciente sufra un ataque cardíaco.
